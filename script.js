...
(function(){
  ...
  function normalizedWeights(){
    ...
    var raw = {
      ...
      back:
        parseFloat(sliders.back.value) || 0,

      side:
        parseFloat(sliders.side.value) || 0,

      stomach:
        parseFloat(sliders.stomach.value) || 0
  ...
  document
    ...
    .addEventListener('click', function(){
      ...
      document.getElementById(
        ...
        'ขนาดนี้เฉลี่ยถ่วงน้ำหนักจากสัดส่วนท่านอนของคุณ ' +
        ...
        'ถ้าเปลี่ยนท่าระหว่างคืนบ่อย ' +

        'ความสูงนี้จะรองรับได้ดีกว่าคำนวณจากท่าเดียว';
